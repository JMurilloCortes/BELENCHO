...
export async function createPayment(req: AuthRequest, res: Response) {
  try {
    const { paymentMethod, customerName, customerEmail, customerPhone, deliveryAddress, deliveryInstructions, neighborhoodId, deliveryDate, deliveryTimeSlot, giftFrom, giftTo, giftMessage, deliveryCost } = req.body;
    ...
    const order = await createOrderFromCart(req.user!.id, paymentMethod, {
      customerName, customerEmail, customerPhone, deliveryAddress, deliveryInstructions, neighborhoodId, deliveryDate, deliveryTimeSlot, giftFrom, giftTo, giftMessage, deliveryCost,
    });
